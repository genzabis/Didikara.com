...
// =======================================================
// BAGIAN LOGIKA PHP UNTUK LAPORAN ADMIN WILAYAH
// =======================================================
...
// Filter OTOMATIS 1: Hanya jenjang SMA/SMK/MA menggunakan edu_level_id
// 3 = SMA/MA, 4 = SMK dari tabel edu_levels Anda.
$where_clauses[] = "r.edu_level_id IN (3, 4)";

// Filter OTOMATIS 2: Hanya dari provinsi milik admin
if (!empty($user_province_id)) {
    $where_clauses[] = "r.province_id = ?";
