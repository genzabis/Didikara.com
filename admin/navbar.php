...
<aside id="sidebar" class="sidebar fixed top-0 left-0 h-screen bg-indigo-900 text-white w-64">
    <div class="p-6">
        ...
        <nav class="space-y-1">
            ...
            <a href="?page=pengguna" class="flex items-center space-x-3 px-4 py-3 rounded-md transition-colors <?php echo ($currentPage === 'pengguna') ? $activeClasses : $inactiveClasses; ?>">
