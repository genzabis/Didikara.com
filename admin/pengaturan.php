                     ...
                     <div class="p-6">
                         ...
                         <div class="space-y-6">
                             ...
                             <div>
                                 ...
                                 <textarea
                                     rows="3"
                                     class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">Platform digital untuk memetakan dan melaporkan masalah pendidikan lokal di Indonesia</textarea>
                             </div>
